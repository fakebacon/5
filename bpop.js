  ...
  jQuery(document).ready(function(){
    ...
    jQuery('.main-navigation-toggle').on('click',function(){jQuery(this).toggleClass('fly');if(jQuery(this).is('.fly')){
                bellowPop();
                if (window.history && window.history.pushState) {window.history.pushState('TRAVEL', null, './#TRAVEL');
                    jQuery(window).on('popstate', function() {bellowDown();});}
